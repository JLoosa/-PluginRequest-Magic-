...
public final class ReflectionUtils {
	 ...
	 *         occur since it searches for a constructor with the types of the
	 *         arguments)
	 ...
	 * @throws IllegalArgumentException If the types of the arguments do not
	 *         match the parameter types of the method (this should not occur
	 ...
	 * @return The value of field of the target object
	 * @throws IllegalArgumentException If the target object does not feature
	 *         the desired field (should not occur since it searches for a field
